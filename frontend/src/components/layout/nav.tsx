...
import { Activity, BarChart2, BotMessageSquare, Camera, Database, Dumbbell, HeartPulse, Lightbulb, Moon, Ruler, Search, Settings, Sun, Scissors, CalendarCheck, Trophy, ScrollText } from "lucide-react";
